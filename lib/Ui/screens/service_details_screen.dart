...
class ServiceDetailsScreenState extends CloudState<ServiceDetailsScreen> {
  //ImageView
  int currentPage = 0;
          ...
          children: [
            Expanded(
              child: _buildButton("editBtnLbl".translate(context), () {
                ...
                Navigator.pushNamed(context, Routes.addServiceDetails,
      ...
      children: [
        ...
        if (model.workingTimes != null && model.workingTimes!.isNotEmpty)
          ...model.workingTimes!.entries.map((entry) {
            final day = entry.key;
            final workingTime = entry.value;
            if (workingTime.isVacationDay) {
              return Padding(
          ...
          Text("noWorkingTimesAvailable".translate(context))
              .color(context.color.textDefaultColor.withOpacity(0.5)),
      ],
    );
  }
