import 'package:eClassify/data/cubits/category/blogs/fetch_blog_sub_categories_cubit.dart';
...
class BlogsSubCategoryScreen extends StatefulWidget {
  final List<BlogCategoryModel> categoryList;
  final String catName;
  final int catId;
  final List<String> categoryIds;

  const BlogsSubCategoryScreen(
      {super.key,
  ...
  @override
  State<BlogsSubCategoryScreen> createState() => _CategoryListState();

  static Route route(RouteSettings routeSettings) {
    Map? args = routeSettings.arguments as Map?;
    return BlurredRouter(
      builder: (_) => BlogsSubCategoryScreen(
...
class _CategoryListState extends State<BlogsSubCategoryScreen>
  ...
  void getSubCategories() {
    if (widget.categoryList.isEmpty) {
      context
          .read<FetchBlogSubCategoriesCubit>()
  ...
  void pageScrollListen() {
    if (controller.isEndReached()) {
      if (context.read<FetchBlogSubCategoriesCubit>().hasMoreData()) {
        context
            .read<FetchBlogSubCategoriesCubit>()
            .fetchSubCategories(categoryId: widget.catId);
      }
                              ...
                              return ListTile(
                                onTap: () {
                                  if (widget.categoryList[index].children!
                                    ...
                                    Navigator.pushNamed(
                                        context, Routes.blogsSubCategoryScreen,
                                        arguments: {
                                          "categoryList": widget
  ...
  Widget fetchSubCategoriesData() {
    return BlocBuilder<FetchBlogSubCategoriesCubit, FetchBlogSubCategoriesState>(
      builder: (context, state) {
        if (state is FetchBlogSubCategoriesInProgress) {
          return shimmerEffect();
        }

        if (state is FetchBlogSubCategoriesFailure) {
          ...
          return Column(
            ...
            children: [
              ListView.separated(
                ...
                itemBuilder: (context, index) {
                  BlogCategoryModel category = state.categories[index];
                  ...
                  return ListTile(
                    onTap: () {
                      if (state.categories[index].children!.isEmpty &&
                        ...
                        Navigator.pushNamed(context, Routes.blogsSubCategoryScreen,
                            arguments: {
