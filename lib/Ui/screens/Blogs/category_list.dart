...
import '../../../data/cubits/category/blogs/fetch_blog_category_cubit.dart';
  ...
  void initState() {
    _pageScrollController.addListener(() {
      if (_pageScrollController.isEndReached()) {
        if (context.read<FetchBlogCategoryCubit>().hasMoreData()) {
          context.read<FetchBlogCategoryCubit>().fetchCategoriesMore();
        }
      }
    });
    super.initState();
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion(
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<FetchBlogCategoryCubit, FetchBlogCategoryState>(
          listener: ((context, state) {
            // if (state is FetchCategorySuccess) {}
          }),
          builder: (context, state) {
            if (state is FetchBlogCategoryInProgress) {
