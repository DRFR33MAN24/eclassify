...
import '../../../data/cubits/service/fetch_item_from_category_cubit.dart' as Service;
...
import '../ServiceHomeScreen/Widgets/item_horizontal_card.dart';
...
class ItemsListState extends State<ItemsList> {
  ...
  void initState() {
    ...
    context.read<Service.FetchItemFromCategoryCubit>().fetchItemFromCategory(
...
//This will create delay so we don't face rapid api call
  ...
  void _loadMore() async {
    if (controller.isEndReached()) {
      if (context.read<Service.FetchItemFromCategoryCubit>().hasMoreData()) {
        context.read<Service.FetchItemFromCategoryCubit>().fetchItemFromCategoryMore(
            catId: int.parse(
              widget.categoryId,
            ),
            search: searchController.text,
                    ...
                    Container(
                        ...
                        child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: "SearchAnyService".translate(context),
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  context
                      .read<Service.FetchItemFromCategoryCubit>()
  ...
  Widget fetchItems() {
    return BlocBuilder<Service.FetchItemFromCategoryCubit, Service.FetchItemFromCategoryState>(
        builder: (context, state) {
      if (state is Service.FetchItemFromCategoryInProgress) {
      ...
      if (state is Service.FetchItemFromCategoryFailure) {
        return Center(
          child: Text(state.errorMessage),
        );
      }
      if (state is Service.FetchItemFromCategorySuccess) {
